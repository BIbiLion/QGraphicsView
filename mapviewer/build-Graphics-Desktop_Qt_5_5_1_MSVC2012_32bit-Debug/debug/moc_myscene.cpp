...
QT_MOC_LITERAL(1, 8, 14), // "cursorPosition"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "MyScene\0cursorPosition\0"
};
...
void MyScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cursorPosition((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyScene::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyScene::cursorPosition)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyScene::cursorPosition(QPointF _t1)
{
